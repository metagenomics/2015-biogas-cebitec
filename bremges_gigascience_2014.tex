...
\caption{\csentence{Relating the metagenome and metatranscriptome.} FPKM values, work in progress! Highlighted are all genes involved in methane metabolism (\href{http://www.genome.jp/kegg-bin/show_pathway?org_name=ko&mapno=00680&mapscale=&show_description=hide}{path:ko00680}). Low-quality image as a placeholder.}
\label{fCoverage}
\end{figure}
%
%\begin{figure}[h!]
