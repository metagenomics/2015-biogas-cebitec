...
Figure \ref{fCoverage} relates the two. Here, we accentuated all genes involved in either of the three known types of methanogenic pathways. Going from CO$_{\text{2}}$ to methane appears to be the highest expressed, which is in agreement with the literature.
\todo[inline]{@Andreas S: Citation needed. Also, probably too much of a statement?}

\section*{Discussion}

We report extensive metagenomic and metatranscriptomic profiling of the microbial community from a production-scale biogas plant. We believe our data are of great interest to the biogas research community in general and microbiologists working on biogas-producing microbial communities in particular.
In a first applied study, our metagenome assembly was used to improve the characterization of a metaproteome generated from biogas plant sludge material and to investigate the metabolic activity of the microbial community \cite{Kohrs2015}.

By sharing our data, we want to actively encourage independent research and also new collaborations within the biogas research community. This will hopefully result in novel biological insights, eventually enabling more efficient biogas production.
...
\todo[inline]{@Peter: Insert Docker runtime metrics, estimating time/memory requirements.}
...
Funding by the German Federal Ministry of Food and Agriculture (BMEL), grant number 22006712 (joint research project Biogas-Core) and the German Federal Ministry of Education and Research (BMBF), grant number 03SF0440C (joint research project Biogas-Marker) is gratefully acknowledged.
\todo[inline]{@Alf: Should we acknowledge support from Stadtwerke Bielefeld?}
\todo[inline]{@All: Did I forget about anything/anyone?}
...
% \bibitem{b1}
% \end{thebibliography}
\todo[inline]{GitHub and DockerHub repositories are still private and don't have a DOI.}
\todo[inline]{The GigaDB repository can be requested after the paper got accepted.}
