...
To further support reproducibility, we bundled all tools and dependencies into one Docker container available on DockerHub \cite{DockerHub}. \emph{docker run} executes the aforementioned Makefile inside the container. Reproduction requires roughly $74\,GiB$ memory and $200\,GiB$ storage.
...
Lastly, we wish to thank C. Titus Brown, Kornél L. Kovács, and Sébastien Boisvert for detailed and constructive open peer reviews.
