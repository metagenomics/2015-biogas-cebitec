...
Reduction of CO$_{\text{2}}$ with hydrogen (hydrogenotrophic methanogenesis) appeared to be highly expressed in the analyzed reactor, which is in agreement with the literature \cite{Zakrzewski2012}.
