...
\subsection*{Relating the metagenome and the metatranscriptome}\todo{TODO}
To highlight potential use cases, we aligned the post-QC sequencing reads to the assembled contigs with bowtie2 \cite{Bowtie2}, version 2.2.4, and used samtools \cite{Samtools}, version 1.1, to convert SAM to BAM and thereafter sort each alignment file. We simply counted the number of reads aligned to all predicted gene with BEDTools, version 2.22.0, \cite{BEDTools}.
...
\subsection*{Reproducibility}\todo{TODO}
